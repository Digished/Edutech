              ...
              {statusFilter === 'pending' && (
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-4 py-1.5 bg-green-600 hover:bg-green-700 disabled:opacity-60 text-white text-xs font-medium rounded-lg transition-colors"
                  >
                    {actionLoading === q.id ? 'Saving…' : 'Approve'}
                  </button>
                  <button
                    disabled={actionLoading === q.id}
